...
public class Attraction {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumns({
            @JoinColumn(name = "gugun_code", nullable = false, columnDefinition = "BIGINT COMMENT '하위 행정구역 고유 번호'"),
            @JoinColumn(name = "sido_code", nullable = false, columnDefinition = "BIGINT COMMENT '행정구역 고유 번호'"),
    })
    private Gugun gugun;
