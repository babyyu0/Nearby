...
public record GugunGetResponse(
        ...
        public GugunGetResponse(int code, String name, int sidoCode) {
                this.code = code;
                this.name = name;
                this.sidoCode = sidoCode;
        }

        public static GugunGetResponse from(Gugun gugun) {
                return GugunGetResponse.builder()
