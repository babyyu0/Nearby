<template>
  <div>
    <b-navbar toggleable="lg" type="light" variant="light">
      <b-navbar-brand to="/">✈️ PyP Trip</b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto" v-if="$store.state.id">
          <b-nav-item-dropdown right>
            <!-- Using 'button-content' slot -->
            <template #button-content>
              <b-avatar variant="info" src="https://placekitten.com/300/300" class="mr-2"></b-avatar> {{ $store.state.name }} 님
            </template>
            <b-dropdown-item to="/member/friend">친구</b-dropdown-item>
            <b-dropdown-item to="/member/info">회원 정보</b-dropdown-item>
            <b-dropdown-item to="/member/logout">로그아웃</b-dropdown-item>
          </b-nav-item-dropdown>
        </b-navbar-nav>
